...
class Model(object):
    def __init__(self, estimator, features, balanced, select_features=None, optimize=False):
        self.estimator, self.features = estimator, features
        self.x_train, self.x_test, self.y_train, self.y_test = pp.split(data, test_size=.2, balanced=balanced)
