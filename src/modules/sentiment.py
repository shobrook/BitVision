...
print("TRAINING INPUT PATH:", os.path.dirname(os.path.dirname(os.getcwd())) + "/datasets/btc_training_data.csv")
print("TESTING INPUT PATH: ", os.path.dirname(os.path.dirname(os.getcwd())) + "/datasets/btc_testing_data.csv")

# Import training and testing data
training_data = pd.read_csv(os.path.dirname(os.path.dirname(os.getcwd())) + "/datasets/btc_training_data.csv", sep=",")
testing_data = pd.read_csv(os.path.dirname(os.path.dirname(os.getcwd())) + "/datasets/btc_testing_data.csv", sep=",")
...
output.to_csv(os.path.join(os.path.dirname(__file__), "/datasets/bag_of_words_model.csv"))