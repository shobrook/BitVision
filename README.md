...
The command-line interface was built by [@alichtman](http://github.com/alichtman), and runs on the `Blessed.js` library. The trading and charting architecture was built by [@shobrook](http://github.com/shobrook), and runs on the `SciPy` stack.
